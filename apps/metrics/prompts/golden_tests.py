...
GOLDEN_TESTS: list[GoldenTest] = [
    ...
    # New tech detection tests (Phase 2 enhancement)
    GoldenTest(
        id="tech_rust_backend",
        description="Rust backend with Cargo",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add rate limiter middleware",
        pr_body="Implemented token bucket rate limiting in Rust.",
        file_count=4,
        additions=280,
        deletions=20,
        repo_languages=["Rust"],
        state="merged",
        file_paths=["src/middleware/rate_limit.rs", "src/lib.rs", "Cargo.toml", "Cargo.lock"],
    ...
    GoldenTest(
        id="tech_nextjs_fullstack",
        description="Next.js with API routes (fullstack)",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add blog CMS",
        pr_body="Next.js pages and API routes for blog management.",
        file_count=5,
        additions=350,
        deletions=10,
        ...
        repo_name="acme-corp/marketing-site",
        expected_ai_assisted=False,
        expected_categories=["frontend", "backend"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_terraform_infra",
        description="Terraform infrastructure",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add AWS EKS cluster",
        pr_body="Terraform modules for EKS cluster with node groups.",
        file_count=6,
        additions=450,
        deletions=0,
        repo_languages=["HCL"],
        ...
        repo_name="acme-corp/infrastructure",
        expected_ai_assisted=False,
        expected_categories=["devops"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_mobile_swift",
        description="iOS Swift mobile app",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add push notifications",
        pr_body="SwiftUI view and AppDelegate for push notifications.",
        file_count=4,
        additions=180,
        deletions=25,
        repo_languages=["Swift"],
        state="merged",
        file_paths=[
            "iOS/NotificationView.swift",
            "iOS/AppDelegate.swift",
            "iOS/PushManager.swift",
            "iOS/Info.plist",
        ],
        repo_name="acme-corp/mobile-app",
        expected_ai_assisted=False,
        expected_categories=["mobile"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_data_pipeline",
        description="Data pipeline with SQL and notebooks",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add daily ETL job",
        pr_body="Spark job for daily user metrics aggregation.",
        file_count=4,
        additions=320,
        deletions=15,
        repo_languages=["Python", "SQL"],
        state="merged",
        file_paths=[
            "pipelines/etl/user_metrics.py",
            "sql/aggregations/daily_metrics.sql",
            "notebooks/data_validation.ipynb",
            "dags/user_metrics_dag.py",
        ],
        repo_name="acme-corp/data-platform",
        expected_ai_assisted=False,
        expected_categories=["data"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_go_microservice",
        description="Go microservice with modules",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add gRPC endpoints",
        pr_body="gRPC service definition and Go handlers.",
        file_count=5,
        additions=280,
        deletions=40,
        repo_languages=["Go", "Protocol Buffer"],
        state="merged",
        file_paths=[
            "cmd/server/main.go",
        ...
        repo_name="acme-corp/user-service",
        expected_ai_assisted=False,
        expected_categories=["backend"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_vue_frontend",
        description="Vue.js frontend application",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add settings page",
        pr_body="Vue 3 composition API settings component.",
        file_count=4,
        additions=220,
        deletions=10,
        repo_languages=["Vue", "TypeScript"],
        state="merged",
        file_paths=[
        ...
        repo_name="acme-corp/admin-panel",
        expected_ai_assisted=False,
        expected_categories=["frontend"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_kotlin_android",
        description="Android Kotlin mobile app",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add biometric login",
        pr_body="BiometricPrompt integration for fingerprint auth.",
        file_count=3,
        additions=150,
        deletions=20,
        repo_languages=["Kotlin", "XML"],
        state="merged",
        file_paths=[
            "app/src/main/java/com/acme/auth/BiometricHelper.kt",
            "app/src/main/java/com/acme/auth/LoginActivity.kt",
            "app/src/main/res/layout/activity_login.xml",
        ],
        repo_name="acme-corp/android-app",
        expected_ai_assisted=False,
        expected_categories=["mobile"],
        expected_pr_type="feature",
    ),
    GoldenTest(
        id="tech_github_actions_ci",
        description="GitHub Actions CI/CD workflow",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add CI pipeline",
        pr_body="GitHub Actions workflow for test and deploy.",
        file_count=3,
        additions=120,
        deletions=0,
        repo_languages=["YAML"],
    ...
    GoldenTest(
        id="tech_sql_only",
        description="SQL-only database migration",
        category=GoldenTestCategory.TECH_DETECTION,
        pr_title="Add user analytics tables",
        pr_body="PostgreSQL tables for user analytics tracking.",
        file_count=3,
        additions=95,
        deletions=0,
        repo_languages=["PLpgSQL"],
        state="merged",
        file_paths=[
            "migrations/V20250101__add_analytics_tables.sql",
            "migrations/V20250102__add_indexes.sql",
            "migrations/V20250103__add_functions.sql",
        ],
        repo_name="acme-corp/database",
        expected_ai_assisted=False,
        expected_categories=["data"],
        expected_pr_type="feature",
    ),
