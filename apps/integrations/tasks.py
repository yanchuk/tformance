...
Tasks are organized into domain-focused modules in _task_modules/:
...
Unmoved tasks (Jira, Slack, Copilot) remain inline here.
All tasks are re-exported for backward compatibility.
"""
...
# =============================================================================
# Jira Sync Tasks (not yet moved to _task_modules/)
# =============================================================================
...
# =============================================================================
# Slack Tasks (not yet moved to _task_modules/)
# =============================================================================
...
# =============================================================================
# Copilot Tasks (not yet moved to _task_modules/)
# =============================================================================
...
__all__ = [
    # GitHub sync tasks (from _task_modules/github_sync)
    "sync_repository_task",
    "create_repository_webhook_task",
    "sync_repository_initial_task",
    "sync_repository_manual_task",
    ...
    "_sync_members_with_graphql_or_rest",
    "_filter_prs_by_days",
    # Metrics tasks (from _task_modules/metrics)
    "aggregate_team_weekly_metrics_task",
    "aggregate_all_teams_weekly_metrics_task",
    "queue_llm_analysis_batch_task",
    # PR data tasks (from _task_modules/pr_data)
    "fetch_pr_complete_data_task",
    "post_survey_comment_task",
    "update_pr_description_survey_task",
    "refresh_repo_languages_task",
