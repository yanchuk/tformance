...
class TestCalculatePRIterationMetrics(TestCase):
    ...
    def test_calculates_total_comments(self):
        ...
        from apps.integrations.services.github_sync import calculate_pr_iteration_metrics
...
class TestCalculateReviewerCorrelations(TestCase):
    ...
    def test_calculates_agreement_for_both_approved(self):
        ...
        from apps.integrations.services.github_sync import calculate_reviewer_correlations
        from apps.metrics.factories import (
            PRReviewFactory,
            PullRequestFactory,
            TeamFactory,
