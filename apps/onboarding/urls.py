...
urlpatterns = [
    ...
    path("github-app/install/", views.github_app_install, name="github_app_install"),
    path("github-app/callback/", views.github_app_callback, name="github_app_callback"),
    ...
    path("copilot/", views.connect_copilot, name="connect_copilot"),
