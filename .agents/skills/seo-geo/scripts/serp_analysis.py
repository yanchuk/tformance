...
from dataforseo_api import api_post, format_count, get_result, print_serp_list
...
def main():
    ...
    data = [{"keyword": args.keyword, "location_code": args.location, "language_code": "en", "depth": args.depth}]
